                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <img src="{{ isset($productVariation->image) ? \Illuminate\Support\Facades\Storage::url($productVariation->image) : \Illuminate\Support\Facades\Storage::url($productVariation->image) }}"
                                                                 class="img-thumbnail"
                                                        ...
                                                        <td>{{ number_format($productVariation->price, 0, ',', '.') }}đ</td>
                                                        <td>
                                                        ...
                                                        <td class="product_total">
                                                            <span class="d-none price">{{ number_format($productVariation->price, 0, ',', '.') }}</span>
                                                            <span class="subtotal">{{ number_format(($productVariation->quantity) * ($productVariation->price), 0, ',', '.') }}</span>đ
                                                        </td>
                                                        <input type="hidden" name="sku" id="" value="{{$productVariation->sku}}">
                                                    </tr>
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div class="card shadow border-0">
                                                            <div class="card-header text-danger">
                                                                <img src="https://i.pinimg.com/originals/66/a6/6b/66a66bca51f6e2770ecfa63c40e97a0a.png" alt="user_icon" width="30" height="30">
                                                                <span style="margin-left: 10px;">Thông Tin Liên Hệ</span>
                                                            </div>
                                                            <div class="card-body">
                                                                    <div class="mb-3">
                                            ...
                                            <div class="card shadow border-0">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <p class="mb-0 fw-bold cart_amount"><span id="total_amount_product">{{ $totalPrice}}</span>đ</p>
                                                    </div>
                                                    <hr>
                                                    ...
                                                    <div class="d-flex justify-content-between shipping-fee-container" style="display: none;">
                                                     ...
                                                     <div class="d-flex justify-content-between">
                                                        ...
                                                        <p class="mb-0 fw-bold text-success "><span class="total">{{ $totalPrice}}</span>đ</p>
