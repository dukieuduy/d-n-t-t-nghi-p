...
<div class="container">
    ...
    <p>Chào bạn, {{ $guestBuyers->isNotEmpty() ? $guestBuyers->first()->name : 'Khách hàng' }}!</p>
            ...
            @foreach($orders as $order)
                <tr>
                    ...
                    <td>
                        ...
                        @if ($order->status === 'completed' && !$order->is_reviewed)
                            <!-- Nút đánh giá -->
                    ...
                    <td>
                        <a href="{{ route('guest.order.detail', $order->id) }}" class="btn btn-info btn-sm">Chi tiết</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
