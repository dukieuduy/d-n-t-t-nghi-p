                                ...
                                @foreach($productRelates as $productRelate)
                                    <div class="single_product">
                                        <div class="product_name">
                                            <h3><a href="{{ route('detail-product', ['id' => $productRelate->id]) }}">{{ $productRelate->name }}</a></h3>
                                            <p class="manufacture_product"><a href="#">Accessories</a></p>
                                        </div>
                                        <div class="product_thumb">
                                            <a class="primary_img" href="{{ route('detail-product', ['id' => $productRelate->id]) }}"> <img src="{{ \Illuminate\Support\Facades\Storage::url($productRelate->image_prd)}}" alt=""></a>
                                            <div class="label_product">
                                                <span class="label_sale">{{ $productRelate->total_sale_percentage }}%</span>
                                            </div>
                                        ...
                                        <div class="product_content">
                                            ...
                                            <div class="product_footer d-flex align-items-center">
                                                <div class="price_box">
                                                    ...
                                                    <span class="regular_price">{{number_format($productRelate->price_new - ($productRelate->price_new * $productRelate->total_sale_percentage / 100))}} đ</span>
                                                </div>
